...
1. Upload a PDF → watch study deck assemble in real time (Supabase realtime)
...
## Full feature list (repo)

All of the following are built but not demoed live in the 4-minute pitch:

- Digital Twin agent (learning profile, confusion tracking)
- Deadline Agent with priority scoring formula
- Study DNA few-shot personalization engine
